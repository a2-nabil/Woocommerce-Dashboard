...
function nxt_wishlist_shortcode($atts) {
    ...
    if (empty($wishlist_items)) {
        return '<div class="nxt-wishlist-empty">
                    <p>' . __('Your wishlist is empty.', 'hello-elementor-child') . '</p>
                    <a href="' . esc_url(wc_get_page_permalink('shop')) . '" class="button">' . __('Continue Shopping', 'hello-elementor-child') . '</a>
                </div>';
    }
    ...
    <div class="nxt-custom-wishlist">
        <div class="nxt-wishlist-header">
            ...
            <span class="nxt-wishlist-count"><?php printf(__('Total %d Products', 'hello-elementor-child'), $total_items); ?></span>
        </div>
...
function nxt_wishlist_preview_shortcode($atts) {
    ...
    if (empty($wishlist_items)) {
        return '<div class="nxt-favorites-empty">
                    ...
                    <a href="' . esc_url(wc_get_page_permalink('shop')) . '" class="button">' . __('Browse Products', 'hello-elementor-child') . '</a>
                </div>';
    }
