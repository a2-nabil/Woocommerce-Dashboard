...
<div class="nxt-orders-page">
        ...
        <div class="nxt-orders-header">
            <div class="count_wrap">
                ...
                <span class="count_number">
                    ...
                    esc_html_e(' Orders', 'hello-elementor-child'); ?></span>
            </div>
                        ...
                        <div class="nxt-order-header">
                            ...
                            <div class="nxt-order-summary">
                                <div class="nxt-order-summary-item">
                                    <span
                                        class="nxt-summary-label"><?php esc_html_e('Total products', 'hello-elementor-child'); ?></span>
                                    <span class="nxt-summary-value"><?php echo esc_html($item_count); ?>
                                        <?php esc_html_e('Products', 'hello-elementor-child'); ?></span>
                                </div>
                                <div class="nxt-order-summary-item">
                                    <span
                                        class="nxt-summary-label"><?php esc_html_e('Total payment', 'hello-elementor-child'); ?></span>
                                    <span
                                        class="nxt-summary-value"><?php echo wp_kses_post($order->get_formatted_order_total()); ?></span>
                                </div>
                                <div class="nxt-order-summary-item">
                                    <span
                                        class="nxt-summary-label"><?php esc_html_e('Payment type', 'hello-elementor-child'); ?></span>
                                    <span
                                        class="nxt-summary-value"><?php echo esc_html($order->get_payment_method_title()); ?></span>
                                </div>
                                <div class="nxt-order-summary-item">
                                    <span
                                        class="nxt-summary-label"><?php esc_html_e('Status order', 'hello-elementor-child'); ?></span>
                                    <span class="nxt-summary-value">
                                        <span
                                            class="nxt-order-status nxt-status-<?php echo esc_attr($order->get_status()); ?>">
                            ...
                            <div class="nxt-order-actions">
                                ...
                                <div class="nxt-expand-btn minus_icon">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M17.7083 10C17.7083 10.5753 17.2419 11.0417 16.6666 11.0417H3.33325C2.75795 11.0417 2.29159 10.5753 2.29159 10C2.29159 9.42474 2.75795 8.95837 3.33325 8.95837H16.6666C17.2419 8.95837 17.7083 9.42474 17.7083 10Z"
                                            fill="black" />
                                    </svg>
                                </div>
                            </div>
                                                        ...
                                                        <div class="nxt-product-meta">
                                                            ...
                                                            <?php if ($category): ?>
                                                                <div class="nxt-meta-item">
                                                                    <span
                                                                        class="nxt-meta-label"><?php esc_html_e('Category:', 'hello-elementor-child'); ?></span>
                                                                    <span
                                                                        class="nxt-meta-value"><?php echo esc_html($category->name); ?>
                                                                    </span>
                                                                </div>
                                                            <?php endif; ?>
                                                            <div class="nxt-meta-item">
                                                                <span
                                                                    class="nxt-meta-label"><?php esc_html_e('Quantity:', 'hello-elementor-child'); ?></span>
                                                                <span
                                                                    class="nxt-meta-value"><?php echo esc_html($item->get_quantity()); ?>
                                                                    <?php esc_html_e('Pcs', 'hello-elementor-child'); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="nxt-shipping-section">
                                            ...
                                            <div class="nxt-address-section">
                                                ...
                                                <div class="nxt-address">
                                                    ...
                                                    <div class="nxt-customer-phone">
                                                        <?php echo esc_html($order->get_shipping_phone()); ?></div>
                                                </div>
                                            </div>
                                            <div class="nxt-extra-info">
                                                <div class="nxt-order-summary-item">
                                                    <span
                                                        class="nxt-summary-label"><?php esc_html_e('Shipping type', 'hello-elementor-child'); ?></span>
                                                    <span
                                                        class="nxt-summary-value"><?php echo esc_html($order->get_shipping_method()); ?></span>
                                                </div>
                                                <div class="nxt-order-summary-item">
                                                    <span
                                                        class="nxt-summary-label"><?php esc_html_e('Estimated arrive', 'hello-elementor-child'); ?></span>
                                                    <span
                                                        class="nxt-summary-value"><?php echo esc_html(nxt_get_estimated_delivery_date($order)); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="nxt-payment-section">
                                        ...
                                        <div class="nxt-address-section">
                                            ...
                                            <div class="nxt-address">
                                                ...
                                                <div class="nxt-customer-email">
                                                    <?php echo esc_html($order->get_billing_email()); ?></div>
                                                <div class="nxt-customer-phone">
                                                    <?php echo esc_html($order->get_billing_phone()); ?></div>
                                            </div>
                                        </div>
                                        <div class="nxt-extra-info nxt-payments-info_wrapper">
                                            ...
                                            <?php if ($card_last4 || $card_expiry): ?>
                                                <div class="nxt-order-summary-item">
                                                    <span
                                                        class="nxt-summary-label"><?php esc_html_e('Card ending', 'hello-elementor-child'); ?></span>
                                                    <span class="nxt-summary-value">
                                                        <?php
                                                        if ($card_last4) {
                                                            if ($card_brand) {
                                                ...
                                                <div class="nxt-order-summary-item">
                                                    <span
                                                        class="nxt-summary-label"><?php esc_html_e('Expiration date', 'hello-elementor-child'); ?></span>
                                                    <span class="nxt-summary-value">
                                                        <?php
                                ...
                                <div class="nxt-order-actions__wrapper">
                                    <div class="nxt-order-actions__info">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            ...
                                            <path
                                                d="M10.202 14.1667V10C10.202 9.60718 10.202 9.41076 10.0799 9.28873C9.95791 9.16669 9.76149 9.16669 9.36865 9.16669"
                                                stroke="#666666" stroke-width="1.25" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M9.99349 6.66669H10.001" stroke="#666666" stroke-width="1.66667"
    ...
    <?php else: ?>
        <div class="nxt-no-orders nxt-no-orders-history">
            <img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/order-empty.png'); ?>"
                alt="<?php esc_html_e('No orders', 'hello-elementor-child'); ?>">
            <h2><?php esc_html_e('Your order history is empty!', 'hello-elementor-child'); ?></h2>
            <p><?php esc_html_e('It looks like you haven’t placed any orders yet. Start exploring our products and place your first order to see it here!', 'hello-elementor-child'); ?>
            </p>
            <a class="nxt-btn nxt-btn-primary"
